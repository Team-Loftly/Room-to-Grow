...
import deskScene from "../../assets/3d/furniture/manDesk.glb";

const ManDesk = (props) => {
  const groupRef = useRef();
  const { nodes, materials, animations } = useGLTF(deskScene);
  const { actions, mixer } = useAnimations(animations, groupRef);

  // Set overall model scale here
  const overallScale = [2.3, 2.3, 2.3];

  // Activate all animations when component mounts
  useEffect(() => {
    console.log('ManDesk available animations:', Object.keys(actions));
    ...
    Object.keys(actions).forEach((actionName) => {
      ...
      if (action) {
        action.play();
        console.log(`Playing ManDesk animation: ${actionName}`);
        
        // Set animation properties
        action.setLoop(THREE.LoopRepeat, Infinity); // Loop forever
        action.clampWhenFinished = true;
        
        // You can adjust animation speed if needed
        // action.timeScale = 0.8; // Slower animation
      }
    });
        ...
        <group name="Sketchfab_model" rotation={[-Math.PI / 2, 0, 0]}>
          <group name="root">
            <group name="GLTF_SceneRootNode" rotation={[Math.PI / 2, 0, 0]}>
              ...
              {/* This is the animated character! */}
